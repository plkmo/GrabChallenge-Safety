...
def convert_timeseries(df, seq_len=1200, interval=3):
    '''
    Converts to time-series by bookingID into sequence length of 1200 each of 3 seconds duration
    ,ignore time > 3600 s
    '''
...
if __name__ == "__main__":
    ...
    ### Convert to time-series by bookingID
